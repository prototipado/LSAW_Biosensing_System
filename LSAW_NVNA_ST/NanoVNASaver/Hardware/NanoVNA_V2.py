...
class NanoVNA_V2(VNA):
    name = "NanoVNA-V2"
    valid_datapoints = (101, 11, 51, 201, 301, 501, 1023, 2049, 4097 )
    screenwidth = 320
    screenheight = 240
    ...
    def __init__(self, iface: Interface):
        ...
        if "S21 hack" in self.features:
            self.valid_datapoints = (101, 11, 51, 201, 301, 501, 1021, 2049, 4093)
    ...
    def readValues(self, value) -> List[str]:
        ...
        if value == "data 0":
            ...
            with self.serial.lock:
                ...
                self.serial.timeout = min(pointstodo, 255) * 0.05
                while pointstodo > 0:
