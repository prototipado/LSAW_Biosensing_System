...
class Datapoint(NamedTuple):
    ...
    def admitance(self, ref_impedance: float = 50) -> complex:
        return 1/(gamma_to_impedance(self.z, ref_impedance))

    def conductance(self, ref_impedance: float = 50) -> complex:
        return ( 1 / ( gamma_to_impedance(self.z, ref_impedance) ) ).real
