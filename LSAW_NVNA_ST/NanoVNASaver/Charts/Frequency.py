...
class FrequencyChart(Chart):
    ...
    def __init__(self, name):
        ...
        self.namebtn = QtWidgets.QAction("Titulo de Gráfica")
        self.namebtn.triggered.connect(lambda: self.helloname())
        self.menu.addAction(self.namebtn)
    ...
    def helloname(self):
        ...
        B1 = ttk.Button (self.root, text="Ok", command = (lambda : self.setitle() ) )
        B1.pack(side="left")

        #self.name_var=self.name_entry.get()
        #self.sweepTitle=self.name_var
    ...
    def setitle(self):
        ...
        #self.root.destroy
        self.setSweepTitle(self.name_entry.get())
        return
